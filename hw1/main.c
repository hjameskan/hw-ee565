...
// this is used to clean up any terminated child processes
...
int main(void) {
    ...
    for(p = servinfo; p != NULL; p = p->ai_next) {
        ...
        if (bind(sockfd, p->ai_addr, p->ai_
    if (p == NULL)  {
    ...
    while(1) { 
        ...
        // print the address of the client that connected
        ...
        // parent process doesn't need the new_fd
        close(new_fd);  
    }
    return 0;
}
